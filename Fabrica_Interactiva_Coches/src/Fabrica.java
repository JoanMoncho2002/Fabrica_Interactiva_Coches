	...
	public class Fabrica {
		...
		public static void main(String[] args) {
			...
			do {
				eleccion = 0;
				System.out.print("1) Fabricar coche (conociendo la matr�cula)\n" +
						"2) Fabricar coche (a partir del n� puertas y el n� de plazas)\n" +
						"3) Fabricar coche (a partir de la marca, el modelo y el color)\n" +
						"4) Fabricar coche (cuando no tenemos ning�n dato)\n" +
						"5) Tunear coche (pint�ndolo de color)\n" +
				...
				try {
					...
					System.out.println("Solo n�meros entre 1-12");
				}
			...
			switch(elec) { 
				case 1:			
					if(Coche.numCoches < Coche.MAX_COCHES) {
						...
						System.out.println("Lo siento el almacen est� lleno.");
					}
					break;
				case 2:
					if(Coche.numCoches < Coche.MAX_COCHES) {
				...
				case 8:
					...
					if(c != null) {
						...
						System.out.println("No se ha encontrado la matr�cula.");
					}*/
					break;
				case 9:
		...
		private static void ordenarRecursivaPorKM(Vector almacen, int i, int j) {
			...
			if(i < almacen.size()-1) { //aqui es -1, porque si j es = a i, i le hacemos +1, se nos va fuera del vector
				...
				//hay que volver a llamar al m�todo
				if(j == almacen.size()-2) { //es j-2 porque j = almacen.size, es j=6, -2 seria 4, arriba hacemos j+1, por tanto digamos q j seria 5, entraria dentro del tama�o del vector
		...
		private static void fabricarConPuertaPlaza(Vector almacen, Coche c) {
			...
			System.out.println("Dame el N� de puertas: ");
			...
			//if(_error) {
				System.out.println("Dame el N� de plazas: ");
				try {
